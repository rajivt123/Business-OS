      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-100">Add Bank / Cash Account</h3>
              <p className="text-xs text-slate-400">Configure financial institution or cash desk foundation</p>
            </div>
          </div>
          <button
            onClick={onClose}
